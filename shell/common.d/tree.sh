_ignore_tree="-I '.git|node_modules|*.py[ocd]|include|lib|local|share|build|__pycache__|.pytest_cache|.cache|.eggs|*.egg-info|venv'"
_ignore_tree="${_ignore_tree%?}|.Trash|.DS_Store|.Trashes|.Spotlight-V100|__MACOSX|.TemporaryItems|.fseventsd'"
_ignore_tree="${_ignore_tree%?}|dryscrape|webkit-server'"
